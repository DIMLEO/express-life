...
_pa.segments = [{"name":"Signed Up","id":646275,"regex":"/dashboard.*/?([?#].*)*$"},{"name":"All visitors","id":639787,"regex":".*"},{"name":"Visited Sign Up Page ","id":3210765,"regex":"/signup.*/?([?#].*)*$"},{"name":"Pricing","id":3210764,"regex":"/pricing.*/?([?#].*)*$"}];
_pa.conversions = [{"name":"Signup","id":"70433","regex":"\\?.*gDisplay"},{"name":"Paid","id":"70434","regex":"\\?.*gConversion"},{"name":"Payment","id":"580704","regex":"\\?.*gConversion2"}];
_pa.conversionEvents = [];
_pa.segmentEvents = [];
_pa.thirdPartyTags = [];
_pa.thirdPartyTagEvents = [];
_pa.allVisitorsSegmentId = 639787;
_pa.clickThroughWindow = 30;
_pa.viewThroughWindow = 30;
_pa.rtbId = '2637';
_pa.siteId = '51412f379bcb66000200028a';
